    ...
    if (userLang_detected != 'ru-ru' && userLang_detected != 'ru') {
        ...
        var tname = "Придумайте и впишите название для создаваемой таблицы.<br>В названии вы можете использовать латинские буквы, а так же любые символы кроме:<br>Слыша - ' / ' или точки - ' . '<br>Так же нельзя использовать только цифры: <strike>1234567</strike>";
